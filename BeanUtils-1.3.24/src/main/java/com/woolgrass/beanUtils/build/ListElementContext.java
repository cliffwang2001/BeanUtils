...
public class ListElementContext implements ObjectContext {
	protected Object value;
	protected ListContext parentContext;
	protected ObjectCategory category;
	protected Class<?> type;
	protected int level;
	protected int index;
	
	public ListElementContext(Object value, ListContext parentContext,
